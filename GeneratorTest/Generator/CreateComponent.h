...
namespace Generator{
    ...
    //=========================================================
	//! \see SelectComponent<Component<Selector, Origin, ConfigRep>, NextSelector>
	struct NextSelector;
	//=========================================================
	//SelectComponent Spezialisierung für Component<..>
	template<class Selector, class Origin, class ConfigRep, class ImplementationType>
	struct SelectComponent<Component<Selector, Origin, ConfigRep>, ImplementationType>
	{
		typedef Selector current_context;
	...
	struct SelectComponent<Component<Selector, Origin, ConfigRep>, NextSelector>
	: SelectComponent<Component<	typename Origin::template BaseType<Selector>::type,
	  	  	  	  	  	  	  	  	Origin, ConfigRep> >
	{};
...
//	};
	...
	template<class CurrentSelector, class OriginContext, class ConfigurationRepository>
	struct Component{
    ...
    struct CS{
		...
		struct BaseType
			: CompositeSelector::BaseType<CurrentSelector, this_type>
        {};
		 //--------------------------------------------------
		// Alternative Delegation ohne Inheritance
		/*
        template<class CurrentSelector>
		struct BaseType{
			typedef typename
				CompositeSelector::BaseType<CurrentSelector, this_type>::type
			type;
		};
        */
        //--------------------------------------------------
    ...
    struct DD{
		...
		struct BaseType
			: DoubleDispatch::BaseType<CurrentContext, this_type>
		{};
//        template<class CurrentContext>
//		struct BaseType{
//			typedef typename
