...
namespace CompositeSelector{
    template<class CurrentSelector, class CSOrigin>
	struct BaseType{
    	typedef typename CSOrigin::Selector OriginContext;
		typedef CS<
			typename CSOrigin::other_type,
			typename OriginContext::template BaseType<
				typename CurrentSelector::Selector>::type>
		type;
	};
